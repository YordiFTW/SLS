...
namespace SLS.Pages.Slijterij
{
    ...
    public class ListModel : PageModel
    {
                                        ...
                                        string SearchAge, WhiskyType SearchType)
        {
            ...
            whiskies = from a in _context.Whiskies
                           select a;
            ...
            whiskies = from g in _context.Whiskies
                       select g;
            ...
            whiskies = from t in _context.Whiskies
                       select t;
            ...
            Whiskies = await whiskies.Where(x => x.IsDeleted==false).ToListAsync();
        }
    }
}
